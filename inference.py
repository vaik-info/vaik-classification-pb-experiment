...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_saved_model_dir_path', type=str, default='~/output_model/2022-11-07-16-15-49/step-1000_batch-8_epoch-9_loss_0.0818_sparse_categorical_accuracy_0.9737_val_loss_0.0595_val_sparse_categorical_accuracy_0.9890')
